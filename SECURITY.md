...
- **Debug-mode information disclosure** — When `CDXGEN_DEBUG_MODE` or `CDXGEN_TRACE_MODE` is explicitly enabled, verbose output is expected and may include file paths, environment details, or command arguments. This is by design for diagnostic use.

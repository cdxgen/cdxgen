 ...
 * FIXME: This is buggy and insecure and needs to be replaced. For starters, this function is invoked multiple times
 *    per project type. Secondly, all the commands gets invoked from within the project directory making it easy for
 *    adversaries to override and execute custom commands. Lastly, envPrefixes and envBlocklist could still result in
 *    sensitive data from being collected. This is because enterprises and users have 100s of ways to leak secrets and
 *    tokens only to blame the SBOM tool later.
 *
 * @param {Object} options

 ...
 *    per project type. Secondly, all the commands are invoked from within the project directory, making it easy for
 *    adversaries to override them and execute custom commands. Lastly, envPrefixes and envBlocklist could still
 *    result in sensitive data being collected. Enterprises and users have hundreds of ways to leak secrets and
 *    tokens, and may still blame the SBOM tool later.
 *
 * @param {Object} options

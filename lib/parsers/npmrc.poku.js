...
const VALID_ENV_CASES = [
  ...
  {
    name: "pnpm_config_ scoped registry auth preserves URL case",
    env: {
      "pnpm_config_//registry.example.com/:_authToken": "pnpm-token",
    },
    expected: { "//registry.example.com/:_authToken": "pnpm-token" },
  },
  {

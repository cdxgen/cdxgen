...
it("framePicker preserves prioritized crypto data-flow frames", () => {
  const cryptoFrames = [
    { module: "source", function: "example.com/app.handler", line: 9 },
    { module: "sink", function: "example.com/app.handler", line: 11 },
  ];
  const longerNonCryptoFrames = [
    { module: "source", function: "example.com/app.handler", line: 13 },
    { module: "call", function: "example.com/app.handler", line: 13 },
    { module: "sink", function: "example.com/app.handler", line: 13 },
  ];

  assert.deepStrictEqual(
    framePicker([cryptoFrames, longerNonCryptoFrames]),
    cryptoFrames,
  );
});

...
describe("toVersRange", () => {
  it("should convert a caret range", () => {
    assert.strictEqual(toVersRange("^1.0.5"), "vers:npm/^1.0.5");
  });

  it("should convert a tilde range", () => {
    assert.strictEqual(toVersRange("~2.1.0"), "vers:npm/~2.1.0");
  });

  it("should convert an exact version", () => {
    assert.strictEqual(toVersRange("9.0.1"), "vers:npm/9.0.1");
  });

  it("should convert a gte range", () => {
    assert.strictEqual(toVersRange(">=2.0.0"), "vers:npm/>=2.0.0");
  });
...
describe("parseExtensionDependencies", () => {
  ...
  it("should parse dependencies with required scope", () => {
    ...
    assert.strictEqual(lodashComp.versionRange, "vers:npm/^4.17.21");
  ...
  it("should skip workspace:* and latest version ranges", () => {
    ...
    assert.ok(realDep);
    assert.strictEqual(realDep.versionRange, "vers:npm/^1.0.0");
  });

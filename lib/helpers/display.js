...
export const buildTableSummaryLines = (
  ...
  if (summaryText) {
    ...
    if (isMergedHostViewBom(bomJson)) {
      ...
      summaryLines.push(
        `Merged host view: ${hostViewSummary.runtimeComponentCount} runtime component(s), ${hostViewSummary.topologyLinkCount} strict hardware/runtime topology link(s), ${hostViewSummary.linkedHardwareComponentCount} linked hardware component(s)`,
      );

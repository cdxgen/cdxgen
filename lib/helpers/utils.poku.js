...
it("parseMillDependency test", () => {
  ...
  assert.deepStrictEqual(
    dependencies.has("pkg:maven/project/bar@latest?type=jar"),
    true,
  );
  assert.deepStrictEqual(
    dependencies.has("pkg:maven/project/bar.test@latest?type=jar"),
    false,
  );
  assert.deepStrictEqual(
    dependencies.has("pkg:maven/project/foo@latest?type=jar"),
    false,
  );
  assert.deepStrictEqual(
    dependencies.has("pkg:maven/project/foo.test@latest?type=jar"),
    false,
  );

...
it("parse requirements.txt captures direct manifest sources", async () => {
  ...
  writeFileSync(
    reqFile,
    [
      "requests @ https://example.com/packages/requests-2.31.0.whl",
    ...
    assert.ok(
      requestsPkg.properties.some(
        (property) =>
          ...
          property.value ===
            "https://example.com/packages/requests-2.31.0.whl",
      ),
    );
...
name = "demo-app"
version = "0.1.0"
dependencies = ["anyio @ https://example.com/packages/anyio.whl"]

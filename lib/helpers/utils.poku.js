...
it("parse go list dependencies", async () => {
  ...
  assert.deepStrictEqual(retMap.pkgList[0], {
    ...
    "bom-ref": "pkg:golang/cel.dev/expr@v0.24.0",
    scope: "optional",
    properties: [
      {
        name: "SrcGoMod",
        value:
          "/Users/prabhu/go/pkg/mod/cache/download/cel.dev/expr/@v/v0.24.0.mod",
      },
      {
      ...
      },
      {
        ...
        value: "h1:hLPLo1W4QUmuYdA72RBX06QTs6MXw941piREPl3Yfiw=",
      },
    ],
  });
});

...
export async function importProtobomModule(
  ...
  try {
    ...
    if (
      ...
      throw new Error(
        `${commandName} ${featureDescription} requires the optional '@appthreat/cdx-proto' dependency. Install optional dependencies or use a binary that bundles protobuf support.`,
      );
    }
    throw error;
  }

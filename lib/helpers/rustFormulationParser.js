...
function parseCargoManifest(filePath) {
  ...
  appendProperty(
    ...
    buildDependencyNames.length ? "true" : undefined,
  );
  appendProperty(
    properties,
  ...
  appendProperty(
    ...
    nativeBuildIndicators.length ? nativeBuildIndicators.join(", ") : undefined,
  );
  appendProperty(
    properties,
    "cdx:cargo:hasNativeBuild",
    hasBuildScript || nativeBuildIndicators.length ? "true" : undefined,
  );
  appendProperty(
    properties,

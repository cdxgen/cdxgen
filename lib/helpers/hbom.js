...
export function ensureHbomRuntimeSupport(options = {}, commandName = "hbom") {
  ...
  const followUpGuidance = normalizedCommandName.endsWith("-slim")
    ? `Use '${standardCommandName}' when you need '--include-runtime', or configure OSQUERY_CMD explicitly.`
    : "Install the optional '@cdxgen/cdxgen-plugins-bin*' companion bundle or configure OSQUERY_CMD explicitly.";
  throw new Error(

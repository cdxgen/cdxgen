...
function createOsQueryBomRef(
  ...
  const identity = [
    ...
    (value) => value !== undefined && value !== null && String(value).length,
  );
  return `osquery/${encodeURIComponent(queryCategory || "component")}/${encodeURIComponent(componentType || "component")}/${encodeURIComponent(name || queryCategory || "component")}@${encodeURIComponent(version || "unknown")}#${encodeURIComponent(String(identity || "unknown"))}`;
}

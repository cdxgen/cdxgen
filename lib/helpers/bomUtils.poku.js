...
describe("bomUtils", () => {
  ...
  it("selects and writes the correct CycloneDX root format key", () => {
    ...
    const bom17 = setCycloneDxFormat({ specVersion: "1.7" }, "1.7");
    ...
    const bom20 = setCycloneDxFormat({ specVersion: 2 }, 2);
    ...
    const internalBom20 = setCycloneDxFormat({ specVersion: 2 }, 2, {

...
function loadPluginToolsInSubprocess(
  ...
  const result = spawnSync(
    ...
    [
      "--input-type=module",
      "-e",
      `import { getPluginToolComponents } from ${JSON.stringify(new URL("./binary.js", import.meta.url).href)}; console.log(JSON.stringify(getPluginToolComponents(${JSON.stringify(toolNames)})));`,
    ],
    {
      cwd: path.dirname(new URL("./binary.js", import.meta.url).pathname),
      encoding: "utf-8",
      env: {
        ...process.env,

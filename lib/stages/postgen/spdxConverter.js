...
const SPDX_CDXGEN_EXTENSION_KEY = "cdxgen:cyclonedx";
...
const buildCycloneDxExtensionData = (component, additionalData = {}) => {
  ...
  addIfDefined(
    extensionData,
    "author",
    toSerializableValue(component?.author),
  );
  addIfDefined(
    extensionData,
    "authors",
  ...
  addIfDefined(
    extensionData,
    "tags",
    toSerializableValue(component?.tags),
  );
  addIfDefined(
    extensionData,
    "releaseNotes",
...
const buildDocumentExtensionData = (bomJson) => {
  ...
  addIfDefined(
    documentExtension,
    "metadataManufacture",
    toSerializableValue(bomJson?.metadata?.manufacture),
  );
  addIfDefined(
    documentExtension,
    "metadataLicenses",
...
const toSpdxPackage = (component, creationInfoId, spdxId) => {
  ...
  if (hashMappings.originalHashes.length) {
    additionalExtensionData.originalHashes = hashMappings.originalHashes;
  }
  if (component?.[SPDX_CDXGEN_EXTENSION_KEY]) {
    additionalExtensionData.syntheticSource =
      component[SPDX_CDXGEN_EXTENSION_KEY];
  }
  ...
  if (extensionData) {
    spdxPackage[SPDX_CDXGEN_EXTENSION_KEY] = extensionData;
  }
  return spdxPackage;
};
...
export function convertCycloneDxToSpdx(bomJson, options = {}) {
  ...
  if (documentExtensionData) {
    spdxDocument[SPDX_CDXGEN_EXTENSION_KEY] = documentExtensionData;
  }
  return {

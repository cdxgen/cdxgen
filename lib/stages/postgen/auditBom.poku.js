...
describe("evaluateRule", () => {
  ...
  it("should ignore stock Microsoft scheduled tasks that use system LOLBAS helpers without suspicious context (OBOM-WIN-006)", async () => {
    const rules = await loadRules(RULES_DIR);
    const rule = rules.find((r) => r.id === "OBOM-WIN-006");
    assert.ok(rule, "OBOM-WIN-006 rule should exist");
    ...
    const bom = makeBom([
      {
        ...
        properties: [
          { name: "cdx:osquery:category", value: "scheduled_tasks" },
          { name: "cdx:lolbas:matched", value: "true" },
          { name: "cdx:lolbas:names", value: "rundll32.exe" },
          {
            name: "cdx:lolbas:functions",
            value: "library-load,proxy-execution",
          },
          { name: "cdx:lolbas:matchFields", value: "action" },
          {
            name: "path",
            value:
    ...
    const bom = makeBom([
      {
        ...
        properties: [
          { name: "cdx:osquery:category", value: "services_snapshot" },
          { name: "cdx:lolbas:matched", value: "true" },
          { name: "cdx:lolbas:names", value: "cmd.exe,powershell.exe" },
          {
            name: "cdx:lolbas:functions",
            value: "command,script-execution,shell",
          },
          { name: "cdx:lolbas:matchFields", value: "description" },
          {
            name: "path",
          ...
          { name: "module_path", value: "C:\\Windows\\System32\\WsmSvc.dll" },
          { name: "start_type", value: "AUTO_START" },
        ],
      },
    ]);
    ...
    const bom = makeBom([
      {
        ...
        properties: [
          ...
          {
            name: "cdx:lolbas:functions",
            value: "command,download,script-execution,shell",
          },
          { name: "cdx:lolbas:matchFields", value: "path" },
          {
            name: "path",
            value: "C:\\Users\\Public\\evil\\powershell.exe -enc AAAA",
          },
          { name: "start_type", value: "AUTO_START" },
        ],
      },

...
// Matches names ending with _TOKEN, _KEY, _SECRET, _PASS, _PASSWORD, _CREDENTIAL, or _CREDENTIALS.
const CREDENTIAL_VAR_PATTERN =
  /_(?:token|key|secret|pass|password|credentials?)$/i;
...
export function auditEnvironment(env = process.env) {
  ...
  // Proxy interception — informational: proxies are common in enterprise environments.

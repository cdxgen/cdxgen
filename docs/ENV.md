...
| ASTGEN_IGNORE_FILE_PATTERN       | Regular expression used to skip files during JavaScript/TypeScript AST generation. Defaults to `(test\|spec\|mock\|setup-jest\|\.d)\.(js\|ts\|tsx)$\|(?<!vite\.\|vue\.)(conf\|config)\.(js\|ts\|tsx)$`, which always skips test, spec, mock, and declaration files, and also skips generic `conf`/`config` files except for `vite.config.*` and `vue.config.*` so that Vite and Vue CLI build-tool packages are correctly scoped. |
...
| JAVA11_TOOL                      | Specifies the Java 11 toolchain version to use. Defaults to `11.0.31-tem` if not explicitly set. Can be overridden to point to a custom Java 11 version.                                                                                                                               |
| JAVA17_TOOL                      | Specifies the Java 17 toolchain version to use. Defaults to `17.0.19-tem` if not explicitly set. Can be overridden to point to a custom Java 17 version.                                                                                                                               |
| JAVA21_TOOL                      | Specifies the Java 21 toolchain version to use. Defaults to `21.0.11-tem` if not explicitly set. Can be overridden to point to a custom Java 21 version.                                                                                                                               |
...
| JAVA25_TOOL                      | Specifies the Java 25 toolchain version to use. Defaults to `25.0.3-tem` if not explicitly set. Can be overridden to point to a custom Java 25 version.                                                                                                                                |
| JAVA26_TOOL                      | Specifies the Java 26 toolchain version to use. Defaults to `26.0.1-tem` if not explicitly set. Can be overridden to point to a custom Java 26 version.                                                                                                                                |

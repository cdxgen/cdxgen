...
| Variable              | Description                                                                                                                                                                                                                                                                                                                                                 |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DOCKER_AUTH_CONFIG    | Process-wide override for Docker auth headers. When set, cdxgen forwards this value for container registry requests instead of consulting `$HOME/.docker/config.json`. Base64 encoded (json) with credentials: `{'username': string, 'password': string, 'email': string, 'serveraddress' : string}`. Alternatively, set the below 4 environment variables. |
...
| DOCKER_EMAIL          | Docker email used with `DOCKER_USER` and `DOCKER_PASSWORD` as a process-wide override for Docker auth headers.                                                                                                                                                                                                                                              |
| DOCKER_HOST           | Docker host. For tcp and ssh hosts, docker cli would be used to pull the image                                                                                                                                                                                                                                                                              |
| DOCKER_PASSWORD       | Docker password used with `DOCKER_USER` and `DOCKER_EMAIL` as a process-wide override for Docker auth headers.                                                                                                                                                                                                                                              |
...
| DOCKER_USER           | Docker username used with `DOCKER_PASSWORD` and `DOCKER_EMAIL` as a process-wide override for Docker auth headers.                                                                                                                                                                                                                                          |

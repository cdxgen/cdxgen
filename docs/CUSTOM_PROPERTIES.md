...
| `cdx:npm:package:development`  | component          | boolean string | `"true"`                                   | When an npm package is only present via dev dependencies | Distinguishes development-only npm packages from optional runtime packages | Context only     |

...
- **ASAR integrity / provenance:** `cdx:asar:declaredIntegrityHash`, `cdx:asar:integrityVerified`, `cdx:asar:integrityBlockSize`, `cdx:asar:integrityBlockCount`, `cdx:asar:primaryManifest`
